...
사전 지도 기반 Planner–RL Tracker 사족 파쿠르 연구 플랫폼. 현재 **P2-04 제자리 정밀 도약·착지·안정화가4개 seed의 개발평가에서 각각64/64 성공한 파일럿** 단계다. 다음은 출발 영역과 실제 비행 이동량을 검증하는 수평 목표 도약이다. 불연속 지형·갭·연속 파쿠르·실기 성능은 아직 검증하지 않았다.
