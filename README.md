...
사전 지도 기반 Planner–RL Tracker 사족 파쿠르 연구 플랫폼. 현재는 **A1의 발별 단독 이동 및 최종 정렬 보상(P1 Step 02b)을 비교한 파일럿** 단계다. 점프나 연속 파쿠르 성공을 의미하지 않는다.

- [최종 정렬 보상 비교 최신 결과](docs/step02b-results.md)
