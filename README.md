...
사전 지도 기반 Planner–RL Tracker 사족 파쿠르 연구 플랫폼. 현재 **P2-04 제자리 정밀 도약·착지·안정화가4개 seed의 개발평가에서 각각64/64 성공한 파일럿** 단계다. P2-05와 P2-06 수평 목표 도약은 성공을 확보하지 못했다. P2-07의6cm 출발 조건에서 비행은 회복됐으나 수평 이동과 seed 재현성 한계가 남았다. 다음은 고정 모델의3cm 조건 재평가다. 불연속 지형·갭·연속 파쿠르·실기 성능은 아직 검증하지 않았다.
