...
사전 지도 기반 Planner–RL Tracker 사족 파쿠르 연구 플랫폼. 현재 **P2-02 평지 소도약 후 안정화는4개 seed의 개발평가에서 각각64/64 성공했지만, 정밀한 첫 착지는 아직 실패한 파일럿** 단계다. 불연속 지형·갭 통과·연속 파쿠르 성능은 아직 검증하지 않았다.
