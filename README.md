...
사전 지도 기반 Planner–RL Tracker 사족 파쿠르 연구 플랫폼. 현재는 **A1의 발별 단독 이동 및 정렬 보상 적용 시점(P1 Step 02c)을 비교하고 추가 학습(P1 Step 02d)을 진행하는 파일럿** 단계다. 점프나 연속 파쿠르 성공을 의미하지 않는다.

- [정렬 비용 적용 시점 최신 결과](docs/step02c-results.md)
