...
사전 지도 기반 Planner–RL Tracker 사족 파쿠르 연구 플랫폼. 현재는 **A1의 발별 단독 이동 및 공유 Tracker의 한계를 기록하고 평지 단일 도약 기준선의 높이·착지 실패를 분석하고 보상 수정(P2-02)을 비교하는 파일럿** 단계다. 점프나 연속 파쿠르 성공을 의미하지 않는다.
