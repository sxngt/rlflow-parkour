...
사전 지도 기반 Planner–RL Tracker 사족 파쿠르 연구 플랫폼. 현재 **P2-03에서 네 seed 모두 첫 착지 반경을 충족했지만, 착지 후 안정화 재현성이 부족한 파일럿** 단계다. 새 정밀 성공은 seed별0/8/0/0(각64개 개발평가 중)이다. 다음은 첫 착지 이후 지지 안정화(P2-04)이며, 불연속 지형·갭·연속 파쿠르 성능은 아직 검증하지 않았다.
