"""P2-32 stage B: frozen two-hop evaluation without intermediate physical reset."""
...
def worker(seed):
    ...
    command=[sys.executable,'scripts/run_job.py','--gpu',str(seed),'--timeout','240','evaluate',
        ...
        '--out',f'artifacts/p2-32-chain-two-hop-seed{seed}','--support-mode','deck','--support-matched-material',
        '--support-calibration','artifacts/p2-11-curriculum-seed0__final-evaluation/run.json',
        '--chain-hops','2','--episodes','64','--diagnostics','--video','--video-envs','64','--video-camera-side','4',
        '--research-tag','phase:P2','--research-tag','step:p2-32-chained-execution',
...
if __name__=='__main__':
    for seed in range(4):
        ...
        p=ROOT/'artifacts'/f'p2-32-chain-two-hop-seed{seed}'
