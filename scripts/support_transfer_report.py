...
def main():
            ...
            for i, touch in enumerate(touches):
                ...
                for foot, name in enumerate(('fl', 'fr', 'rl', 'rr')):
                    ...
                    if mode == 'flat':
                        ...
                        surface = next(s for s in support['layout']['surfaces']
    ...
    (ROOT/'docs/p2-14-summary.json').write_text(json.dumps(summary, indent=2)+'\n')
    ...
    (ROOT/'docs/p2-14-results.md').write_text('\n'.join(lines))
    print('\n'.join(lines))
