"""Summarize matched history training and retention outcomes."""
import json
from pathlib import Path
from p4_03_evaluate import evaluation_plan
...
if __name__=='__main__':
    ...
    (ROOT/'docs/p4-03-comparison.json').write_text(json.dumps({'new_training_steps':4*800*1024*24,'evaluations':rows},indent=2)+'\n')
    lines=['# P4-03 matched final evaluations','','| Condition | Seed | Uniform eight-hop | Friction 0.2 | Friction 0.05 | Continuous regression |','|---|---:|---:|---:|---:|---:|']
    ...
    (ROOT/'docs/p4-03-comparison.md').write_text('\n'.join(lines)+'\n')
    print('\n'.join(lines))
