"""P2-32 stage A: frozen one-jump controls on the existing large deck."""
...
def worker(seed):
    ...
    command=[sys.executable,'scripts/run_job.py','--gpu',str(seed),'--timeout','240','evaluate',
        ...
        '--out',f'artifacts/p2-32-deck-single-seed{seed}','--support-mode','deck','--support-matched-material',
        ...
        '--research-tag','terrain:deck','--research-tag','purpose:single-jump-control']
...
if __name__=='__main__':
    for seed in range(4):
        ...
        p=ROOT/'artifacts'/f'p2-32-deck-single-seed{seed}'
