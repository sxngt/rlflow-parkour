...
def main():
    ...
    p.add_argument("kind", choices=["train", "evaluate", "collision_probe", "support_probe", "support_assignment_probe", "mapped_contact_probe", "shared_terrain_probe", "continuous_tracker_probe", "planner_rollout_probe", "online_planner_probe", "render_online_probe"])
