# P2-29-FIRST-BATCH-INTERMEDIATE 최초 착지 이후 목표 유지

> 중간 기록: 순서를 균형 배치한 첫 네 run만 포함한다. 전체 지형 효과 및 회귀 평가는 미완료다.
...
![동일 scenario 0의 발별 오차](figures/p2-29-first-batch-intermediate-post-landing.png)
