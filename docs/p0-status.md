...
## P2-08 검증 완료와 P2-09 시작

P2-08의5cm 성공은 보상군16/16·14/16, 대조군0/16씩이며3cm 출발 재평가에서도 유지됐다. 제자리 seed1 회귀10/16과10/15cm 실패는 남았다. 원본좌표 및 총12run 감사 통과,영상8개 보존. P2-09는 같은 보상으로0–15cm 학습을 네 seed 신규 정책에서 검사한다. source4b20205,총157,286,400step. [프로토콜](p2-09-protocol.md)과 [현재 인계](active-research.md).
